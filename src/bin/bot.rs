...
use liquidation_bot::arbitrum::stats::{
    ...
    get_price_decimals_state, get_prices_state, get_reserve_all_state, get_reserve_state,
    get_tokens_state, get_user_account_data_state, get_user_state, get_users_state,
    get_variable_borrow_index_state, get_variable_borrow_state, AppState,
};
use std::sync::Arc;
