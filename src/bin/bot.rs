...
use liquidation_bot::arbitrum::stats::{get_borrowed_all_state, get_borrowed_matrix_row_state, get_borrowed_matrix_state, get_borrowed_state, get_collateral_all_state, get_collateral_matrix_row_state, get_collateral_matrix_state, get_collateral_state, get_decimals_state, get_full_state, get_health_factors_state, get_liquidation_threshold_state, get_liquidity_index_state, get_liquidity_state, get_price_decimals_state, get_prices_state, get_reserve_all_state, get_reserve_state, get_tokens_state, get_user_state, get_users_state, get_variable_borrow_index_state, get_variable_borrow_state};
use std::sync::Arc;
    ...
    match args.commands {
        Commands::Start => {
            ...
            let app = Router::new()
                ...
                .route("/collateral_matrix/{row_num}", get(get_collateral_matrix_row_state))
                ...
                .route("/borrowed_matrix/{row_num}", get(get_borrowed_matrix_row_state))
