...
use crate::arbitrum::arbitrum::IL2Pool::{Borrow, IL2PoolEvents, Repay, Supply, Withdraw};
...
use crate::arbitrum::events::{answer_updated, borrow, create_user, repay, supply, withdraw};
