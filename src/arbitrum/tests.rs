...
use crate::arbitrum::arbitrum::IL2Pool::{Borrow, IL2PoolEvents, Repay, ReserveUsedAsCollateralEnabled, Supply, Withdraw};
...
use crate::arbitrum::events::{answer_updated, borrow, create_user, repay, reserve_used_as_collateral_enabled, supply, withdraw};
